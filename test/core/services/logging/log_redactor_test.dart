...
void main() {
  ...
  group('redactBody', () {
    ...
    test('masks GitHub, GitLab, Slack, and Stripe token prefixes', () {
      const body =
          '{"message":"tokens: ghp_0123456789abcdefghijklmnopqrstuvwxyz '
      ...
      expect(redacted, contains('glp***wxyz(len=32)'));
      expect(redacted, contains('xox***ghij(len=26)'));
      expect(redacted, contains('sk_***wxyz(len=34)'));
    });
