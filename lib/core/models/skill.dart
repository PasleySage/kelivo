...
class Skill {
  ...
  // How many keychain-backed secret placeholders this skill's content holds.
  // Used to clear the right number of keychain entries on overwrite/delete
  // without scanning the whole OS keychain (#4).
  ...
  factory Skill.fromJson(Map<String, dynamic> json) {
    ...
    return Skill(
      ...
      secretCount: (json['secretCount'] as num?)?.toInt() ?? 0,
      versions:
